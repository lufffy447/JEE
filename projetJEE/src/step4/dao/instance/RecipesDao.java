...
public class RecipesDao {
	...
	public ArrayList<RecipeModel> getAllRecipes() {
		...
		// create connection
			...
			RecipeModel recipe;
			while(results.next()) {
				recipe = new RecipeModel(results.getString("title"), results.getString("description"), results.getInt("expertise"), results.getInt("duration"), results.getInt("nbpeople"), results.getString("type"));
